            ...
            <div class="container">
                ...
                <div id="navbarCollapse" class="collapse navbar-collapse navbar-right">
                    ...
                    <ul class="nav nav-pills">
                        ...
                        <li class="active"> <a href="${pageContext.request.contextPath}/rating">Рейтинг фильмов</a> </li>
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        <td class="col-lg-1 col-md-1 col-xs-2">
                            <img class="img-responsive img-thumbnail" src="${pageContext.request.contextPath}/img/inter.png" alt="интерстеллар">
                        </td>
                        <td class="vert-align"><a href="${pageContext.request.contextPath}/show">Интерстеллар</a></td>
                    ...
                    <tr>
                        <td class="col-lg-1 col-md-1 col-xs-2">
                            <img class="img-responsive img-thumbnail" src="${pageContext.request.contextPath}/img/cloud.png" alt="Облачный атлас">
                        </td>
                    ...
                    <tr>
                        <td class="col-lg-1 col-md-1 col-xs-2">
                            <img class="img-responsive img-thumbnail" src="${pageContext.request.contextPath}/img/matrix.png" alt="Матрица">
                        </td>
                    ...
                    <tr>
                        <td class="col-lg-1 col-md-1 col-xs-2">
                            <img class="img-responsive img-thumbnail" src="${pageContext.request.contextPath}/img/max.png" alt="Безумный макс">
                        </td>
                    ...
                    <div class="panel-body">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item list-group-warning">
                                ...
                                <a href="${pageContext.request.contextPath}/show">Интерстеллар</a>
                            </li>
