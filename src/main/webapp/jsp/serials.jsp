            ...
            <div class="container">
                ...
                <div id="navbarCollapse" class="collapse navbar-collapse navbar-right">
                    ...
                    <ul class="nav nav-pills">
                        ...
                        <li class="active"><a href="${pageContext.request.contextPath}/serials">Сериалы</a></li>
                ...
                <div class="row">
                    <div class="well clearfix">
                        <div class="col-lg-3 col-md-2 text-center">
                            <img class="img-thumbnail" src="${pageContext.request.contextPath}/img/dead.png" alt="ходячие мертвецы">
